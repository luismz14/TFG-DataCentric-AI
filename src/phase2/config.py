...
PHASE2_CONFIDENCE_ONLY_FRAMES_DIR = Path("phase2/frames_confidence_only")
PHASE2_FULL_TRAIN_CSV = Path("phase2/phase2_train.csv")
PHASE2_TRAIN_CONF040_CSV = Path("phase2/phase2_train_conf040.csv")
PHASE2_TRAIN_CSV = PHASE2_TRAIN_CONF040_CSV
PHASE2_TRAIN_CONF040_THRESHOLD = 0.40
PHASE2_CONFIDENCE_ONLY_THRESHOLD = 0.60

PHASE2_MAX_CANDIDATES_PER_VIDEO = 15
PHASE2_TARGET_FPS = 5
PHASE2_WINDOW_SEC = 3
